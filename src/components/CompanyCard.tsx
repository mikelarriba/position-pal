import { Building2, ExternalLink, Linkedin, ChevronDown, ChevronRight, Trash2, Sparkles, Loader2, Plus } from "lucide-react";
import { useState } from "react";
import { Button } from "@/components/ui/button";
import { PositionCard } from "./PositionCard";
import { StatusBadge } from "./StatusBadge";
import { useDeleteCompany, useEnrichCompany } from "@/hooks/usePositions";
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Button
              ...
              onClick={(e) => {
                e.stopPropagation();
                onAddPosition(company.id, company.name);
              }}
            >
      ...
      {expanded && company.positions.length === 0 && (
        <div className="border-t border-border bg-muted/20 p-4 text-center">
          ...
          <Button
            ...
            size="sm"
            className="mt-2"
            onClick={() => onAddPosition(company.id, company.name)}
          >
